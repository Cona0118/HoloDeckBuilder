...
export const CARDS: Card[] = [
  ...
  // hSD14
  {
    ...
    life: 4,
    color: ["white"],
    imageUrl: "/images/hSD14/hSD14-001_OC.png",
    oshiAbility: {
      name: "모두 같이 가자앗",
      cost: "홀로 파워 -2",
      description:
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#1기생", "#게이머즈", "#동물귀", "#그림"],
    imageUrl: "/images/hSD14/hSD14-002_C.png",
    abilities: [
      { name: "시작해복치!", description: "", damage: 20, cost: ["colorless"] },
    ],
    limit: 4,
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#1기생", "#게이머즈", "#동물귀", "#그림"],
    imageUrl: "/images/hSD14/hSD14-003_C.png",
    abilities: [
      {
        name: "오늘도 당신 곁에 -후부키-",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#1기생", "#게이머즈", "#동물귀", "#그림"],
    imageUrl: "/images/hSD14/hSD14-004_C.png",
    abilities: [
      {
        name: "시라카미 쪽으로 와",
        description:
          "자신이 후공이고 최초의 턴이라면, 자신의 덱에서 마스코트 1장을 공개하고, 패에 더한다. 그리고 덱을 셔플 한다.",
        timing: "collab",
      },
      {
        name: "하이 프렌즈!",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#1기생", "#게이머즈", "#동물귀", "#그림"],
    imageUrl: "/images/hSD14/hSD14-005_U.png",
    abilities: [
      {
        name: "하나둘, 셋넷",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#1기생", "#게이머즈", "#동물귀", "#그림"],
    imageUrl: "/images/hSD14/hSD14-006_C.png",
    abilities: [
      {
        name: "드디어 너와 만났다!!!",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#1기생", "#게이머즈", "#동물귀", "#그림"],
    imageUrl: "/images/hSD14/hSD14-007_U.png",
    abilities: [
      {
        name: "Message for you -후부키-",
        description:
          "자신의 센터 홀로멤 1명을 고른다. 이 턴 동안, 고른 홀로멤의 아츠 +10.",
        timing: "bloom",
      },
      {
        name: "달—콤한— 이 기—분—",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#1기생", "#게이머즈", "#동물귀", "#그림"],
    imageUrl: "/images/hSD14/hSD14-008_R.png",
    abilities: [
      {
        name: "괜찮다구요!",
        description: "자신의 아카이브의 마스코트 1장을 이 홀로멤에게 붙인다.",
        timing: "collab",
      },
      {
        name: "같이 가자",
        description:
          "[콜라보 포지션 한정] 이 홀로멤에게 마스코트가 붙어 있다면, 이 아츠 +20.",
        damage: 20,
        cost: ["colorless"],
      },
    ],
  ...
  },
  {
    ...
    supportSubtype: "staff",
    limited: true,
    imageUrl: "/images/hSD14/hSD14-010_C.png",
    abilities: [{ name: "", description: "자신의 덱을 3장 드로우 한다." }],
    limit: 4,
  },
  {
    ...
    supportSubtype: "mascot",
    tags: ["#시라카미's 캐릭터"],
    imageUrl: "/images/hSD14/hSD14-011_C.png",
    abilities: [
      {
        name: "",
        description:
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#DEV_IS", "#ReGLOSS", "#술"],
    imageUrl: "/images/hSD15/hSD15-002_C.png",
    abilities: [
      {
        name: "들러 보세요 보고 가세요",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#DEV_IS", "#ReGLOSS", "#술"],
    imageUrl: "/images/hSD15/hSD15-003_C.png",
    abilities: [
      {
        name: "오늘도 당신 곁에 -라덴-",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#DEV_IS", "#ReGLOSS", "#술"],
    imageUrl: "/images/hSD15/hSD15-004_C.png",
    abilities: [
      {
        name: "잠깐 쉬는 이른 아침 라덴",
        description:
          "자신이 후공이고 최초의 턴이라면, 자신의 옐 덱의 위에서부터 1장을 자신의 백 홀로멤에게 보낸다.",
        timing: "collab",
      },
      {
        name: "산책이라도 어떠신지요?",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#DEV_IS", "#ReGLOSS", "#술"],
    imageUrl: "/images/hSD15/hSD15-006_C.png",
    abilities: [
      {
        name: "세계를 물들이는 -라덴-",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#DEV_IS", "#ReGLOSS", "#술"],
    imageUrl: "/images/hSD15/hSD15-007_U.png",
    abilities: [
      {
        name: "여행 전날",
        description:
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#DEV_IS", "#ReGLOSS", "#술"],
    imageUrl: "/images/hSD15/hSD15-008_R.png",
    abilities: [
      {
        name: "여명",
        description:
          "이 홀로멤이 상대의 홀로멤을 다운 시켰을 때, 이 홀로멤의 HP를 20 회복한다.",
        timing: "gift",
      },
      {
        name: "버섯채취",
        description:
          "이 턴에 자신이 #버섯을 가진 이벤트를 사용하고 있다면, 이 아츠 +10.",
        damage: 40,
        cost: ["green", "colorless"],
      },
    ],
  ...
  },
  {
    ...
    batonPass: 2,
    tags: ["#DEV_IS", "#ReGLOSS", "#술"],
    imageUrl: "/images/hSD15/hSD15-009_RR.png",
    abilities: [
      {
        name: "더・파천황",
        description: "[센터 포지션 한정] 이 턴 동안, 이 홀로멤의 아츠 +20.",
        timing: "bloom",
      },
      {
        name: "전통과 혁신을 당신에게",
  ...
  },
  {
    ...
    supportSubtype: "event",
    tags: ["#버섯"],
    imageUrl: "/images/hSD15/hSD15-010_C.png",
    abilities: [
      {
        name: "",
        description:
  ...
  // hSD16
  {
    ...
    life: 4,
    color: ["red"],
    imageUrl: "/images/hSD16/hSD16-001_OC.png",
    oshiAbility: {
      name: "35P 여기 여기",
      cost: "홀로 파워 -2",
      description:
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-002_C.png",
    abilities: [
      {
        name: "사쿠라 미코야~",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-003_C.png",
    abilities: [
      {
        name: "엘리트 무녀 아이돌! 사쿠라 미코야~",
        description: "",
        damage: 30,
        cost: ["red"],
      },
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-004_C.png",
    abilities: [
      {
        name: "후공인데-요",
        description:
          "자신이 후공이고 최초의 턴이라면, 자신의 덱에서 〈35P〉 1장을 공개하고, 이 홀로멤에게 붙인다. 그리고 덱을 셔플 한다.",
        timing: "collab",
      },
      { name: "댝쳐!", description: "", damage: 20, cost: ["colorless"] },
    ],
    limit: 4,
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-005_U.png",
    abilities: [
      {
        name: "벚꽃바람 런닝",
        description:
          "주사위를 1번 굴린다. 3이나 5라면, 자신의 덱을 1장 드로우 한다.",
        damage: 20,
        cost: ["colorless"],
      },
    ],
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-006_C.png",
    abilities: [
      {
        name: "모두 봐줘니에",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-007_U.png",
    abilities: [
      {
        name: "미코 무릎에 누워 봐",
        description:
      ...
      {
        name: "미코의 귀 파기 스킬로 녹아버려라",
        description:
          "[센터 포지션 한정] 주사위를 1번 굴린다. 3이나 5라면, 이 아츠 +10.",
        damage: 30,
        cost: ["colorless"],
      },
    ],
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-008_R.png",
    abilities: [
      {
        name: "기다렸니에",
        description:
          "주사위를 1번 굴린다. 3이나 5라면, 자신의 아카이브의 〈35P〉 1장을 패로 되돌린다.",
        timing: "collab",
      },
      { name: "잔뜩 놀자", description: "", damage: 30, cost: ["colorless"] },
    ],
    limit: 4,
  },
  {
    ...
    batonPass: 2,
    tags: ["#JP", "#0기생", "#베이비"],
    imageUrl: "/images/hSD16/hSD16-009_RR.png",
    abilities: [
      {
        name: "35P, 고마워—!",
        description:
      ...
      {
        name: "이 순간을 보여주고 싶었달까",
        description: "",
        damage: 100,
        specialDamage: { color: "yellow", value: 30 },
        cost: ["red", "colorless", "colorless"],
      },
    ],
    limit: 4,
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#노래"],
    imageUrl: "/images/hSD17/hSD17-002_C.png",
    abilities: [
      {
        name: "버추얼 아이돌・호시마치 스이세이",
        description: "",
        damage: 20,
        cost: ["colorless"],
      },
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#노래"],
    imageUrl: "/images/hSD17/hSD17-003_C.png",
    abilities: [
      {
        name: "오늘도 당신 곁에 -스이세이-",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#노래"],
    imageUrl: "/images/hSD17/hSD17-004_C.png",
    abilities: [
      {
        name: "퍼스트 스타",
        description:
          "자신이 후공이고 최초의 턴이라면, 상대의 백 홀로멤 1명에게 특수 대미지 20을 준다.",
        timing: "collab",
      },
      {
        name: "나만의 반짝임",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#노래"],
    imageUrl: "/images/hSD17/hSD17-005_U.png",
    abilities: [
      {
        name: "좋아, 레슨 개시다—!",
        description: "상대의 백 홀로멤 1명에게 특수 대미지 10을 준다.",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#노래"],
    imageUrl: "/images/hSD17/hSD17-006_C.png",
    abilities: [
      {
        name: "슬슬 시작해!",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#0기생", "#노래"],
    imageUrl: "/images/hSD17/hSD17-008_R.png",
    abilities: [
      {
        name: "내일로의 노래",
        description:
  ...
  },
  {
    ...
    abilities: [
      ...
      },
      {
        ...
        description: "",
        damage: 110,
        specialDamage: { color: "purple", value: 30 },
        cost: ["blue", "blue", "colorless"],
      },
    ],
    limit: 4,
  },
  {
    ...
    type: "support",
    supportSubtype: "event",
    imageUrl: "/images/hSD17/hSD17-010_C.png",
    abilities: [
      {
        name: "",
        description:
  ...
  // hSD18
  {
    ...
    life: 4,
    color: ["purple"],
    imageUrl: "/images/hSD18/hSD18-001_OC.png",
    oshiAbility: {
      name: "라이밍",
      cost: "홀로 파워 -2",
      description:
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-002_C.png",
    abilities: [
      {
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-003_C.png",
    abilities: [
      {
        name: "오늘도 당신 곁에 -칼리오페-",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-004_C.png",
    abilities: [
      {
        name: "여—러분",
        description:
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-005_U.png",
    abilities: [
      {
        name: "사신식 스트레칭",
        description:
          "자신의 툴이 붙어 있는 홀로멤이 있다면, 상대의 센터 홀로멤에게 특수 대미지 10을 준다.",
        timing: "collab",
      },
      {
        name: "함께, 어때?",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-006_C.png",
    abilities: [
      {
        name: "이제부터, 노력할게",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-007_U.png",
    abilities: [
      {
        name: "조금 특별한 프레젠트",
        description:
          "상대의 턴에서, 이 홀로멤이 다운 했을 때, 자신의 덱의 위에서부터 1장을 아카이브 한다.",
        timing: "gift",
      },
      {
        name: "도와줘서 살았어",
        description: "이 홀로멤에게 툴이 붙어 있다면, 이 아츠 +10.",
        damage: 30,
        cost: ["colorless"],
      },
    ],
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-008_R.png",
    abilities: [
      {
        name: "로큰롤 리퍼",
        description: "자신의 덱의 위에서부터 1장을 아카이브 한다.",
      ...
      },
      {
        name: "OK, 1곡 더 가자!",
        description:
          "[센터 포지션 한정] 자신의 아카이브의 툴 1장을 패로 되돌린다.",
        damage: 40,
        cost: ["purple", "colorless"],
      },
    ],
  ...
  },
  {
    ...
    batonPass: 2,
    tags: ["#EN", "#Myth", "#노래"],
    imageUrl: "/images/hSD18/hSD18-009_RR.png",
    abilities: [
      {
        name: "페일 라이더",
        description:
          "자신의 아카이브에 홀로멤이 6장 이상 있다면, 상대의 센터 홀로멤에게 특수 대미지 20을 준다.",
        timing: "collab",
      },
      {
        name: "새기자 명계의 비트",
        description: "",
        damage: 90,
        specialDamage: { color: "green", value: 30 },
        cost: ["purple", "purple"],
      },
    ],
    limit: 4,
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#2기생", "#새"],
    imageUrl: "/images/hSD19/hSD19-002_C.png",
    abilities: [
      {
        name: "아지마루 아지마루~",
        description: "",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#2기생", "#새"],
    imageUrl: "/images/hSD19/hSD19-003_C.png",
    abilities: [
      {
        name: "오늘도 당신 곁에 -스바루-",
        description: "자신의 라이프가 2 이하라면, 이 아츠 +10.",
        damage: 20,
        cost: ["yellow"],
      },
    ],
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#2기생", "#새"],
    imageUrl: "/images/hSD19/hSD19-004_C.png",
    abilities: [
      {
        name: "오오조라 스마일",
        description:
          "자신이 후공이고 최초의 턴이라면, 자신의 덱에서, Debut 홀로멤 1장을 공개하고, 스테이지에 낸다. 그리고 덱을 셔플 한다.",
        timing: "collab",
      },
      { name: "슈바!", description: "", damage: 20, cost: ["colorless"] },
    ],
    limit: 4,
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#2기생", "#새"],
    imageUrl: "/images/hSD19/hSD19-005_U.png",
    abilities: [
      {
        name: "댄스 레슨인데요",
        description: "이 홀로멤이 상대의 센터 홀로멤에게서 받는 대미지 -10.",
        timing: "gift",
      },
      {
        name: "하나둘, 홧, 홧!",
  ...
  },
  {
    ...
    batonPass: 1,
    tags: ["#JP", "#2기생", "#새"],
    imageUrl: "/images/hSD19/hSD19-006_C.png",
    abilities: [
      {
        name: "잔뜩 힘낼게!",
        description: "",
  ...
  },
  {
    ...
    batonPass: 2,
    tags: ["#JP", "#2기생", "#새"],
    imageUrl: "/images/hSD19/hSD19-009_RR.png",
    abilities: [
      {
        name: "댄싱・플레이아데스",
        description: "자신의 라이프가 2 이하라면, 이 아츠 +10.",
        damage: 80,
        specialDamage: { color: "white", value: 30 },
        cost: ["yellow", "yellow"],
      },
    ],
    limit: 4,
  },
  {
    ...
    supportSubtype: "event",
    tags: ["#음식"],
    imageUrl: "/images/hSD19/hSD19-010_C.png",
  ...
  },
  {
    ...
    oshiAbility: {
      ...
      cost: "홀로 파워 -1",
      description:
        "[턴에 1번] 상대의 센터 홀로멤 1명을 고른다. 다음 상대의 턴이 종료할 때까지, 고른 홀로멤의 배턴 터치에 필요한 홀로아츠 N +3.",
    },
    spAbility: {
      name: "가라가라 돈돈!",
      cost: "홀로 파워 -2",
  ...
  },
  {
    ...
    oshiStageAbility: {
      name: "벌써 금요일이네 루이네",
      description:
        "자신의 턴이 종료할 때, 자신의 센터 홀로멤이 〈타카네 루이〉고, 자신의 콜라보 홀로멤이 있다면, 패가 4장이 될 때까지, 자신의 덱을 드로우 한다.",
    },
    oshiAbility: {
      name: "호이사 호이사",
      cost: "홀로 파워 -2",
  ...
  },
  {
    ...
    oshiAbility: {
      ...
      cost: "홀로 파워 -2",
      description:
        "[턴에 1번] 자신의 턴이 종료할 때, 이 턴에 자신의 〈오토노세 카나데〉가 센터 포지션에서 아츠를 사용했었다면, 사용할 수 있다 : 자신의 센터 홀로멤과 자신의 #ReGLOSS를 가진 백 홀로멤 1명을 교대시킨다.",
    },
    spAbility: {
      name: "짝짝짝 고마워!",
      cost: "홀로 파워 -1",
      description:
        "[게임에 1번] 자신의 옐 덱의 위에서부터 3장을 자신의 센터 홀로멤인 〈오토노세 카나데〉에게 보낸다. 이 턴이 종료할 때, 자신의 스테이지의 옐 3장을 아카이브 한다.",
    },
  },
  {
    id: "hBP08-008",
    ...
    abilities: [
      {
        ...
        description:
          "자신의 홀로 파워를 본다. 그중에서 서포트 카드 1장을 공개하고, 패에 더한다. 그리고 홀로 파워를 셔플 한다. 패에 더했다면, 자신의 덱의 위에서부터 1장을 홀로 파워로 한다.",
        timing: "collab",
      },
      {
    ...
    abilities: [
      {
        name: "아이돌이 되고 싶은 나",
        description:
          "[센터 포지션・콜라보 포지션 한정] 자신의 덱을 2장 드로우 한다.",
        timing: "bloom",
      },
      {
        name: "분위기가 고조되면 좋겠다!",
        description:
          "자신의 오시 홀로멤이 〈토키노 소라〉라면, 자신의 스테이지의 다른 〈토키노 소라〉 1명을 고른다. 이 턴 동안, 고른 홀로멤의 아츠는, 상대의 2nd인 백 홀로멤도 대상으로 할 수 있다.",
        damage: 150,
        specialDamage: { color: "red", value: 50 },
    ...
    abilities: [
      {
        name: "차 마시는 시간",
        description:
          "자신의 휴식하고 있는 #Justice를 가진 홀로멤이 2명 이상 있다면, 이 턴 동안, 자신의 스테이지의 홀로멤 전원의 아츠 +20.",
        timing: "collab",
      },
      {
        name: "휴식도 중요하죠?",
    ...
    abilities: [
      {
        name: "홀로나츠 곱빼기 파르페",
        description:
          "자신의 툴이 붙어 있는 〈아키 로젠탈〉 1명을 고른다. 이 턴 동안, 고른 홀로멤의 아츠 +20. 고른 홀로멤이 Buzz 홀로멤이나 2nd 홀로멤이라면, 대신, 그 홀로멤의 아츠 +50.",
        timing: "bloom",
      },
      {
        name: "한 입 먹을래?",
        description: "자신의 툴이 붙어 있는 홀로멤 1명의 HP 30 회복.",
        damage: 50,
        cost: ["green", "colorless"],
      },
    ],
    ...
    abilities: [
      {
        ...
        timing: "gift",
        description:
          "[콜라보 포지션 한정][턴에 1번] 상대의 턴에서, 자신의 #비밀 결사 holoX를 가진 센터 홀로멤이 아츠 대미지를 받았을 때, 자신의 덱의 위에서부터 1장을 홀로 파워로 한다.",
      },
      {
        name: "극비임무 수행중이오",
        description: "",
    ...
    abilities: [
      {
        name: "트윙클・아이돌",
        description:
          "자신의 스테이지에 〈후와와 어비스가드〉가 있다면, 상대의 센터 홀로멤이나 콜라보 홀로멤에게 특수 대미지 20을 준다.",
        timing: "bloom",
      },
      {
        name: "간BAU 할게—!",
    ...
    abilities: [
      {
        name: "벚꽃 낌새에 이끌려",
        description:
          "이 홀로멤에게 〈귀신도 「아수라」〉가 붙어 있고, 상대의 콜라보 홀로멤이 없다면, 상대는, 자신의 백 홀로멤 1명을 콜라보 포지션으로 이동시킨다(이동은 콜라보로 취급하지 않는다).",
        timing: "collab",
      },
      {
        name: "꽃구경 데이트",
    ...
    abilities: [
      {
        name: "마제스틱・디보션",
        description:
          "[콜라보 포지션 한정] 상대의 턴에서, 이 홀로멤 이외의 자신의 #Justice를 가진 홀로멤이 다운 했을 때, 자신의 덱에서, 2nd 홀로멤 1장을 공개하고, 패에 더한다. 그리고 덱을 셔플 한다.",
        timing: "gift",
      },
      {
        name: "스위트 투스",
    ...
    abilities: [
      {
        name: "너에게 맡겨 버릴까나?",
        description:
          "상대의 턴에서, 이 홀로멤이 다운 했을 때, 자신의 옐 덱의 위에서부터 1장을 자신의 백 홀로멤에게 보낸다.",
        timing: "gift",
      },
      {
        name: "눈사람 만들자",
    ...
    abilities: [
      {
        name: "기운이 나는 구미",
        description:
          "상대의 센터 홀로멤의 배턴 터치에 필요한 홀로아츠 N이 5개 이상이라면, 자신의 옐 덱의 위에서부터 1장을 자신의 〈미즈미야 스우〉에게 보낸다.",
        damage: 70,
        specialDamage: { color: "red", value: 50 },
        cost: ["blue"],
      },
    ...
    abilities: [
      {
        ...
        description:
          "자신의 덱에서, 1st 홀로멤인 〈모코코 어비스가드〉 1장을 공개하고, 패에 더한다. 그리고 덱을 셔플 한다.",
        timing: "collab",
      },
      {
        name: "있는 힘껏 하고 올게!",
    ...
    abilities: [
      {
        name: "싸움 환영",
        description:
          "자신의 패 1장을 아카이브 할 수 있다 : 상대의 센터 홀로멤이나 콜라보 홀로멤에게 특수 대미지 30을 준다.",
        timing: "collab",
      },
      {
        name: "잠들지 않는 마을의 해결사",
        description:
          "자신의 덱에서, 〈루이토모〉 1장을 자신의 홀로멤에게 붙인다. 그리고 덱을 셔플 한다.",
        damage: 20,
        cost: ["colorless"],
      },
    ],
    ...
    abilities: [
      {
        name: "여름의 방문",
        description:
          "자신의 스테이지에 #그림을 가진 홀로멤이 3명 이상 있다면, 자신의 덱을 1장 드로우 한다.",
        timing: "collab",
      },
      {
        name: "괜찮게 됐지, 더 할 수 있어",
        description: "",
        damage: 30,
        cost: ["colorless"],
      },
    ...
    abilities: [
      {
        name: "TOMORROW!?",
        description:
          "상대의 오시 홀로멤과 서로 다른 색을 가진 상대의 홀로멤 1명에게 특수 대미지 20을 준다.",
        timing: "bloom",
      },
      {
        name: "Bonk!",
  ...
  },
  {
    ...
    abilities: [
      ...
      {
        name: "최고의 친구",
        description: "자신의 센터 홀로멤이 2nd 홀로멤이라면, 이 아츠 +30.",
        damage: 20,
        cost: ["colorless"],
      },
    ],
  ...
  },
  {
    ...
    nameJp: "hololive Mythology",
    keywords: ["홀로라이브 미솔로지", "미스"],
    type: "support",
    supportSubtype: "event",
    limited: true,
