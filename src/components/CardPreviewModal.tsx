...
export default function CardPreviewModal({ card, onClose, onSelectImage, onSplitToImage, selectedImageUrl }: CardPreviewModalProps) {
  ...
  const qnaSearchUrl = `https://hololive-official-cardgame.com/rules/question/search/?keyword=${encodeURIComponent(card.cardNumber)}&keyword_type%5B%5D=all&search_type=and&expansion=`;
